...
# this will import our functn frm the views.py in our todo app

urlpatterns = [
    path('admin/', admin.site.urls),
    path("", views.get_todo_list, name="get_todo_list"),
    # takes 3 arguments:url,functn n name
    ...
    #  from links or forms
    # in our templates.Through the URL and into the
    #  view which expects it as a parametr.
